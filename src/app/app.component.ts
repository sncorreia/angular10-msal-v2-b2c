...
import { EventMessage, EventType, InteractionType, InteractionStatus, PopupRequest, RedirectRequest, AuthenticationResult, AuthError, Logger } from '@azure/msal-browser';
...
export class AppComponent implements OnInit, OnDestroy {
  title = 'MSAL Angular v2 B2C with Angular 10';
  isIframe = false;
  loginDisplay = false;
